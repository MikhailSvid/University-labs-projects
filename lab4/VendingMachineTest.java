...
public class VendingMachineTest {
    ...
    public void myTest(){
        ...
        String result1 = vm1.getMessage();
        System.out.println("vm 1 initial message: " + result1);
        vm1.add("Coke", 8);
        result1 = vm1.getMessage();
        System.out.println("vm 1 initial message: " + result1);
        System.out.println("vm1 stock: " + vm1.checkStock());

        VendingMachine vm2 = new VendingMachine();
        String result2 = vm2.getMessage();
        System.out.println("vm 2 initial message: " + result2);
        System.out.println("vm2 stock: " + vm2.checkStock());
        vm1.add("Coke", 7);
        result1 = vm1.getMessage();
        System.out.println("vm 1 message: " + result1);
        System.out.println("vm1 stock: " + vm1.checkStock());
        result2 = vm2.getMessage();
        System.out.println("vm 2 message: " + result2);
        System.out.println("vm2 stock: " + vm2.checkStock());
